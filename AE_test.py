...
dataloader=process_data(view=view)
...
net = net.to(device)
net.load_state_dict(torch.load(f"./models/AE_view{view}_ep500.pth",map_location=device))
...
with torch.no_grad():
    ...
    np.save(f"./data/AE_view{view}.npy", out)
